...
module Bengt
  module ActionAdapters
    class Slack
      ...
      def perform(payload)
        ::Slack::Notifier.new(configuration.url, configuration.options).ping payload.public_send(configuration.post_method).to_s
      end
      ...
      class Configuration
        ...
        attribute :post_method, String, default: 'url'
